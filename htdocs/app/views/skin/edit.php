...
<html lang="en">
  ...
  <body>
    <div class = 'container'>
      ...
      <div class = "form-group">
        <label>Champion: <input type="text" name="champion", value = '<?=$data->champion ?>' class = "form-control"></label>
      </div>
      <div class = "form-group">
      ...
      <div class = "form-group">
        <label>Discount: <input type="text" name="discount", value = '<?=$data->discount ?>' class = "form-control"></label>
      </div>
			<input type="submit" name="action" value = 'Save changes' class = "btn btn-success">
			<a href = '/skin/index' class = "btn btn-secondary">Cancel</a>
		</form>
    </div>
    <!-- Optional JavaScript -->
