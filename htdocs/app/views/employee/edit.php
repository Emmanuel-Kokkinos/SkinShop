      ...
      <h1>Edit this Employee</h1>
		<form action = '' method = 'post'>
			<div class = "form-group">
				<label>Name: <input type="text" name="username", value = '<?=$data->username ?>' class = "form-control"></label>
			</div>
      <div class = "form-group">
        <label>Admin <input type="checkbox" name="is_admin" value = '1' class = "form-control"></label>
      </div>
